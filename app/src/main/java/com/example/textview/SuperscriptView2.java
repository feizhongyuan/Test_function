...
/**
 * Created by fei .
 * Created by Date 2019/7/26 17:51
 */

public class SuperscriptView2 extends TextView {
    public final static int Gravity_LEFT_TOP=1,Gravity_RIGHT_TOP=2;
    private float mOffsetX, mOffsetY;
    private float mOffsetDegress;
    private int mHeight, mWidth;
    private int mGravity;
    public SuperscriptView2(Context context) {
        super(context);
    }

    public SuperscriptView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SuperscriptView2(Context context, AttributeSet attrs, int defStyle) {
