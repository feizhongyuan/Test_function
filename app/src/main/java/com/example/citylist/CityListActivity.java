...
import com.example.citylist.db.DBHelper;
import com.example.citylist.db.DatabaseHelper;
import com.example.citylist.entity.City;
import com.example.citylist.utils.DensityUtil;
import com.example.citylist.utils.PingYinUtil;
import com.example.citylist.view.LetterListView;
...
public class CityListActivity extends AppCompatActivity implements
        LetterListView.OnTouchingLetterChangedListener, AbsListView.OnScrollListener {
