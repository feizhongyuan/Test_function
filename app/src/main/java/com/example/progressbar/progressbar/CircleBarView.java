package com.example.progressbar.progressbar;
...
import com.example.progressbar.utils.DpOrPxUtils;
...
public class CircleBarView extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        progressColor = typedArray.getColor(R.styleable.CircleBarView_progress_color,Color.WHITE);
